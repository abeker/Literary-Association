...
insert into user_entity(id, city, country, deleted, email, first_name, last_name, last_password_reset_date, password, user_type, username, is_approved)
values ('0896abd9-932d-4998-8a83-2a00d9bf77e5', 'Subotica', 'Serbia', false, 'committee@gmail.com', 'Garet', 'Potson', '2020-11-12 21:58:58.508-07', '$2y$12$gybDgJIv2AUWRDF5cXcrBukmP/SHshcXRic1QyRvq5ymHJK0Siqnu', 'COMMITTEE_MEMBER', 'committee', true);
insert into user_entity(id, city, country, deleted, email, first_name, last_name, last_password_reset_date, password, user_type, username, is_approved)
